...
const Comments = () => {
  ...
  const comments = [
    ...
    {
      text: 'В офисе аварийных комиссаров заполнили все документы для страховой компании. Мне осталось только их отвести в страховую компании и съездить на экспертизу. Очень удобно что ваша служба аварийных комиссаров работает по всей России сохранил ваш телефон, так как дальнобойщик и не знаешь где понадобиться ваша помощь. Аварийный комиссар оформил документы по европротоколу, не пришлось ехать в ГИБДД седеть там часами в ожидании. Спасибо за ваш труд.',
      name: 'Лаврентий Карпов',
    },
    {
      text: 'На парковке детского сада поцарапала машину, не знала что делать, позвонила мужу он вызвал аварийных комиссаров. Приехал молодой парень объяснил, что когда повреждения маленькие аварию оформляют без ГИБДД по протоколу страховой компании. На следящий день забрала протокол в офисе аварийных комиссаров и увезла в свою страховую.',
      name: 'Анна Булкина',
    },
    {
      text: 'В городе Санкт-Петербурге был в командировке на два дня а руководство задач нарезало за недель не успеть. Как на зло на парковке девушка задавая назад въехала в мой служебный автомобиль. Первые мысли что все встречи и переговоры накрылись медным тазом. Но виновница предложила оформится через аварийных комиссаров. Комиссар приехал быстро от фотографировал все, записал повреждения и отпустил меня. На следящей день приехал в офис аварийных комиссаров и забрал документы. Спасибо вы сэкономили мое время сто позволило мне решить все дела намеченные на командировку.',
